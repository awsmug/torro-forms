		...
		<table class="form-table">
			<tr>
				...
				<td class="forminp forminp-textarea">
					<p><?php _e( 'This text will be used on thanking members after participating survey.', 'surveyval-locale' ); ?></p><br />
					<input class="settings-template-subject" type="text" name="surveyval_thankyou_participating_subject_template" value="<?php echo sv_get_mail_template_subject( 'thankyou_participating' ); ?>" /><br />
			...
			<tr>
				...
				<td class="forminp forminp-textarea">
					...
					<input class="settings-template-subject" type="text" name="surveyval_invitation_subject_template" value="<?php echo sv_get_mail_template_subject( 'invitation' ); ?>" /><br />
			...
			<tr>
				...
				<td class="forminp forminp-textarea">
					...
					<input class="settings-template-subject" type="text" name="surveyval_reinvitation_subject_template" value="<?php echo sv_get_mail_template_subject( 'reinvitation' ); ?>" /><br />
