<?php
/**
 * Template tag WYSIWYG field class
 *
 * @package TorroForms
 * @since 1.0.0
 */
...
use Leaves_And_Love\Plugin_Lib\Fields\WYSIWYG;

/**
 * Class for a template tag WYSIWYG field.
 *
 * @since 1.0.0
 */
class Template_Tag_WYSIWYG_Field extends WYSIWYG {
	...
	public function enqueue() {
		...
		if ( Template_Tag_Text_Field::has_enqueued() ) {
			return $ret;
		}
