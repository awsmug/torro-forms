...
class Translations_Element_Setting_Manager extends Translations_Manager {
	...
	protected function init() {
		$this->translations = array(
			...
			'rest_item_slug_description'          => __( 'A unique alphanumeric identifier for the element setting.', 'torro-forms' ),
			'rest_item_title_description'         => __( 'The element setting title.', 'torro-forms' ),
			...
			'rest_collection_slug_description'    => __( 'Limit result set to element settings with one or more specific slugs.', 'torro-forms' ),
			'rest_collection_title_description'   => __( 'Limit result set to element settings with a specific title.', 'torro-forms' ),
