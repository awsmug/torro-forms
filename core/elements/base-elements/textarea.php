...
final class Torro_Form_Element_Textarea extends Torro_Form_Element {
	...
	public function get_input_html() {
		...
		$html .= '<textarea id="' . $this->get_input_id() . '" name="' . $this->get_input_name() . '" maxlength="' . $this->settings[ 'max_length' ]->value . '" rows="' . $this->settings[ 'rows' ]->value . '" cols="' . $this->settings[ 'cols' ]->value . '">' . esc_html( $this->response ) . '</textarea>';
